...
// FetchWorkflowExecutionDataByListOfWorkflows provides a mock function with given fields: ctx, SummaryFilters, onlyWorkflowIds
func (_m *IDocDBClient) FetchWorkflowExecutionDataByListOfWorkflows(ctx context.Context, SummaryFilters documentDB_client.SummaryFilters, onlyWorkflowIds bool) ([]primitive.M, error) {
	ret := _m.Called(ctx, SummaryFilters, onlyWorkflowIds)

	var r0 []primitive.M
	if rf, ok := ret.Get(0).(func(context.Context, documentDB_client.SummaryFilters, bool) []primitive.M); ok {
		r0 = rf(ctx, SummaryFilters, onlyWorkflowIds)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, documentDB_client.SummaryFilters, bool) error); ok {
		r1 = rf(ctx, SummaryFilters, onlyWorkflowIds)
	} else {
		r1 = ret.Error(1)
	}
...
// GetTimedoutTask provides a mock function with given fields: ctx, WorkflowId
